...
/* =========================================================
   COMPONENT
========================================================= */
function StepSpecificationsComponent({
  nextStep,
  prevStep,
        ...
        <div className="flex flex-col gap-4 rounded-2xl bg-white p-6 shadow-sm lg:flex-row lg:items-center lg:justify-between">
          <div>
            ...
            <p className="mt-1 text-sm text-gray-500">
              Define technical details like size, material, and
              performance metrics
            </p>
          </div>
            ...
            <div className="overflow-hidden rounded-2xl border border-gray-200 bg-white shadow-lg">
              ...
              <div className="flex flex-wrap items-center justify-between gap-4 border-b border-gray-200 bg-linear-to-r from-gray-50 to-white px-6 py-4">
                <div>
                  ...
                  <p className="text-sm text-gray-500">
                    Add product technical information
                  </p>
                </div>
              ...
              {specifications.length === 0 && (
                <div className="p-12 text-center">
                  ...
                  <p className="mt-1 text-sm text-gray-500">
                    Add technical details like dimensions,
                    materials, or performance specs
                  </p>
                ...
                <>
                  ...
                  <div className="divide-y divide-gray-100">
                    {specifications.map((spec, index) => (
                      <div
                        key={index}
                        className="group p-4 transition hover:bg-gray-50 sm:p-5"
                      >
              ...
              <div className="flex items-start gap-3">
                ...
                <div>
                  ...
                  <p className="mt-1 text-xs leading-relaxed text-amber-700">
                    ...
                    perform better in search results and
...
const StepSpecifications = memo(
  StepSpecificationsComponent
);
