export const STATE_LGAS: Record<string, string[]> = {
  LAGOS: [
    "Ikeja","Eti Osa","Surulere","Alimosho","Kosofe","Mushin","Ojo","Ikorodu",
    "Agege","Ifako-Ijaiye","Shomolu","Amuwo-Odofin","Lagos Island",
    "Lagos Mainland","Badagry","Epe","Ibeju-Lekki",
  ],

  EDO: [
    "Oredo","Egor","Ikpoba-Okha","Ovia North-East","Ovia South-West",
    "Orhionmwon","Uhunmwonde","Esan West","Esan Central","Esan North-East",
    "Esan South-East","Etsako West","Etsako Central","Etsako East","Akoko-Edo",
  ],
  ...
  DELTA: [
    ...
    "Sapele","Udu","Ughelli North","Ughelli South","Ukwuani","Uvwie",
...
KANO: ["Ajingi","Albasu","Bagwai","Bebeji","Bichi","Bunkure","Dala","Dambatta","Dawakin Kudu","Dawakin Tofa",
  ...
  "Nasarawa","Rano","Rimin Gado","Rogo","Shanono","Sumaila","Takai","Tarauni","Tofa",
  "Tsanyawa","Tudun Wada","Ungogo","Warawa","Wudil",
],

KATSINA: ["Bakori","Batagarawa","Batsari","Baure","Bindawa","Charanchi","Dandume",
  "Danja","Dan Musa","Daura","Dutsi","Dutsin Ma","Faskari","Funtua","Ingawa","Jibia","Kafur",
  "Kaita","Kankara","Kankia","Katsina","Kurfi","Kusada","Mai'Adua","Malumfashi","Mani","Mashi",
...
NASARAWA: ["Akwanga","Awe","Doma","Karu","Keana","Keffi","Kokona",
...
OGUN: ["Abeokuta North","Abeokuta South","Ado-Odo/Ota",
  "Egbado North","Egbado South","Ewekoro","Ifo","Ijebu East","Ijebu North","Ijebu North East",
  "Ijebu Ode","Ikenne","Imeko Afon","Ipokia","Obafemi Owode","Odeda","Odogbolu","Ogun Waterside",
  "Remo North","Shagamu",
],
...
TARABA: [
  ...
  "Gassol","Ibi","Jalingo","Karim Lamido","Kumi","Lau","Sardauna",
  "Takum","Ussa","Wukari","Yorro","Zing",
],

YOBE: [ "Bade", "Bursari", "Damaturu", "Fika", "Fune", "Geidam", "Gujba",
